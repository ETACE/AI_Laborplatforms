...
def copy_weights(source_model, target_model):
    ...
    #if source_model.input_shape != target_model.input_shape:
    #    raise ValueError("Source and target models have mismatched input shapes.")
...
class NeuralNetModel(tf.keras.Model):
    ...
    def log_weights_and_activations(self, inputs, log_file="weights_activations.log"):
        """
        Logs weights and activations to a specified log file.
        """
